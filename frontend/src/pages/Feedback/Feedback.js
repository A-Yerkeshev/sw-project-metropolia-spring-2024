...
import {  Box, Container, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, TextField, Button,  Typography } from '@mui/material';
      ...
      >
        ...
        <FormLabel component="legend" className={styles.legend}>Rate:</FormLabel>
          ...
          <Box className={styles.submitButtonContainer}>
            <Button onClick={handleSubmit} variant="contained" color="primary" sx={{ marginTop: 2 }}>Submit</Button>
          </Box>
          {submitStatus && (
  <Box mt={2} className={styles[submitStatus]}>
    <Typography variant="body1" color={submitStatus === 'success' ? 'green' : 'red'}>
      {submitMessage}
    </Typography>
  </Box>
)}        
